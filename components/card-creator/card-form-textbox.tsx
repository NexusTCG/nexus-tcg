...
export default function CardFormTextBox({ activeMode }: CardFormTextBoxProps) {
  ...
  const bgColorClass50 =
    activeMode === "anomaly" ? null : calculateBgColor(energyCost, 50)[0];
  ...
  return (
    ...
    >
      {activeMode === "initial" && cardGrade && cardType !== "event" && (
      ...
      <div className="flex-grow w-full overflow-hidden">
        <CardText activeMode={activeMode} />
      </div>
