...
// export default async function Image({ params }: { params: { slug: string } }) {
//   try {
//     console.log("[OpenGraph] Generating image for slug:", params.slug);
...
//           "cache-control": "no-cache, no-store", // Keep no-cache while debugging
//         },
//       }
//     );
//   } catch (error) {
...
//           }}
//         >
//           <h1 style={{ fontSize: 60 }}>Nexus TCG</h1>
//           <p style={{ fontSize: 30 }}>Error generating card image</p>
//           <p style={{ fontSize: 20, maxWidth: "80%", textAlign: "center" }}>
